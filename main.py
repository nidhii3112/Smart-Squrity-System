...
label_title = tk.Label(frame1, text="SMART SQURITY SYSTEM")
label_font = font.Font(size=50, weight='bold',family='Helvetica')
...
btn2_image = btn2_image.resize((40,40), Image.ANTIALIAS)
btn2_image = ImageTk.PhotoImage(btn2_image)

btn5_image = Image.open('icons/exit2.png')
...
btn7_image = Image.open('icons/iden.png')
...
btn1 = tk.Button(frame1, text='Monitor', height=90, width=180, fg='red',command = find_motion, image=btn1_image, compound='left')
btn1['font'] = btn_font
btn1.grid(row=3, pady=(20,10))

btn2 = tk.Button(frame1, text='Rectangle', height=90, width=180, fg='red', command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
btn2.grid(row=3, pady=(20,10), column=3, padx=(20,5))

btn_font = font.Font(size=25)
btn3 = tk.Button(frame1, text='Noise', height=90, width=180, fg='red', command=noise, image=btn3_image, compound='left')
btn3['font'] = btn_font
...
btn7 = tk.Button(frame1, text="identify", fg="red",command=maincall, compound='left', image=btn7_image, height=90, width=180)
btn7['font'] = btn_font
